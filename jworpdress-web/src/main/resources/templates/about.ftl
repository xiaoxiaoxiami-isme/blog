        ...
        <div class="col-sm-12 blog-main">
            <div class="blog-body expansion">
                ...
                <div class="info">
                    ...
                    所有转载的文章皆来源于互联网，若因此对原作者造成侵权，烦请原作者<a target="_blank" href="mailto:liuhaihua@59et.com" title="点击给我发邮件" data-toggle="tooltip" data-placement="bottom" rel="external nofollow"><strong>告知</strong></a>，我会立刻删除相关内容。
                </div>
                <h5 class="legend-title">赞助</h5>
                <div class="alert alert-warning alert-dismissible simple-alert fade-in" role="alert">
                    <strong>注!</strong> 如果您觉得我的网站能够帮助到您，请您多多支持。我的支付宝账号：<span class="label label-success">liuhaihua#59et.com</span>（#==@）！
