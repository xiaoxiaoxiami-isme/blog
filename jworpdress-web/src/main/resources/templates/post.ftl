...
<@header title="${article.postTitle} | ${config.siteName}"
    keywords="${article.keywords?if_exists},${config.siteName}"
    description="${article.postExcerpt?if_exists}"
...
<#if article.coverImage?exists>
    <img src="${config.siteUrl}${article.coverImage?if_exists}" onerror="this.src='${config.siteUrl}/img/default_article_cover.jpg'" style="display: none;" id="cover-img">
</#if>
        ...
        <div class="col-sm-8 blog-main">
                ...
                <div class="article-flag">
                    ...
                    <div class="blog-info-meta pull-right">
                        <ul class="list-unstyled list-inline">
                            <li><i class="fa fa-clock-o fa-fw"></i>发表于 ${article.postDate?string('yyyy年MM月dd日')}</li>
                ...
                <div class="blog-info overflow-initial">
                    <div class="bottom-line">
                        <h1 class="blog-info-title">
                            <strong>${article.postTitle}</strong>
                        </h1>
                    </div>
                ...
                <div class="cat">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            本文为互联网转载文章，出处已在文章中说明(部分除外)。如果侵权，请<a target="_blank" href="mailto:jxausea@gmail.com" title="点击给我发邮件" data-toggle="tooltip" data-placement="bottom"><strong>联系本站长</strong></a>删除，谢谢。
            ...
            <div class="blog-body">
                <a href="https://promotion.aliyun.com/ntms/act/ambassador/sharetouser.html?userCode=wylo59db&utm_source=wylo59db" target="_blank" rel="external nofollow">
                    <img src="${config.siteUrl}/img/ad/aliyun_sale1000-60.png" alt="阿里云首购8折" class="img-responsive">
                </a>
            </div>
            <div class="blog-body prev-next">
                <nav class="nav-single wow" data-wow-delay="0.3s">
                    <#if prev??>
                        <a href="${config.siteUrl}/archives/${prev.id?c}" rel="prev">
                            <span class="meta-nav" data-original-title="${prev.postTitle}" data-toggle="tooltip" data-placement="bottom"><span class="post-nav"><i class="fa fa-angle-left"></i> 上一篇</span>
                                <br>${prev.postTitle}
                            </span>
                        </a>
                    <#else >
                    ...
                    <#if next??>
                        <a href="${config.siteUrl}/archives/${next.id?c}" rel="next">
                            <span class="meta-nav" data-original-title="${next.postTitle}" data-toggle="tooltip" data-placement="bottom"><span class="post-nav">下一篇 <i class="fa fa-angle-right"></i></span>
                                <br>${next.postTitle}
                            </span>
                        </a>
                    <#else >
                                ...
                                <div class="line-container">
                                    <div class="line-left">
                                        <#if item.coverImage?exists>
                                            <img class="lazy-img" data-original="${config.siteUrl}${item.coverImage?if_exists}" width="50" height="50" rel="external nofollow"/>
                                        <#else>
                                            <img class="lazy-img" data-original="${config.siteUrl}/img/favicon.ico" width="50" height="50" rel="external nofollow"/>
                                        </#if>
                                    </div>
                                    <div class="line-right">
                                        <div class="text">
                                            <a href="${config.siteUrl}/archives/${item.id?c}" data-original-title="${item.lookCount?if_exists}人浏览了该文章" data-toggle="tooltip" data-placement="bottom">
                                                ${item.postTitle}
                                            </a>
                                        </div>
                                        <div class="text">
                                            ...
                                            <span class="comment" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="文章评论次数">
                                                <a href="${config.siteUrl}/archives/${item.id?c}#comment-box" rel="external nofollow">
