    <link href="${config.siteUrl}/img/favicon.ico" rel="shortcut icon" type="image/x-icon">
    ...
    <link href="${config.siteUrl}/css/zhyd.core.css" rel="stylesheet" type="text/css">
    <link href="${config.siteUrl}/css/zhyd.comment.css" rel="stylesheet" type="text/css">